...
//         const apiUrls = [
//           `/api/news?country=us`,
//           `/api/news?sources=bbc-news`,
//           `/api/news?country=de&category=business`,
//           `/api/news?q=trump`,
//           `/api/news?everything=bitcoin`,
//           `/api/news?everything=apple&from=2024-05-15&to=2024-05-15&sortBy=popularity`,
//           `/api/news?domains=techcrunch.com,thenextweb.com`,
//         ];
